...
AWS_S3_ENDPOINT_URL = "http://minio:9000" #TO DO Alberto: parametrizar minio en env variable
...
FLOW_FROM_EMAIL = os.getenv("FLOW_FROM_EMAIL", EMAIL_HOST_USER)
...
BRAND = {
    ...
    "hosts": ["nono-labs.com"],
    "domain": "rapidpro.nono-labs.com",
    "emails": {"notifications": "support@rapidpro.nono-labs.com"},
    "logos": {
